...
export default function Home() {
  return (
    <div className="page-wrap">
          ...
          <div className="nav_link-wrap">
            <div className="nav_link-wrap_center">
              <div
                ...
                className="nav-link_drop-wrap"
              >
                <div className="drop_trigger">
                  <div className="nav-llnk">
                    <div>Individuals</div>
                    <div className="show_tablet">
                      <div className="icon_16 w-embed">
                        <svg
                          width="100%"
                          height="100%"
                          viewBox="0 0 7 11"
                ...
                <div className="drop_open">
                  <div className="drop_holder">
                    <div clip="true" className="nav-link_product-wrap">
                      <div className="nav-link_product-col">
                        <img
                          src="../cdn.multiversx.com/webflow/nav-individual-grid.webp"
                          loading="lazy"
                          className="nav-individual_grid"
                        />
                        <img
                          src="../cdn.multiversx.com/webflow/nav-individuals-visual.webp"
                          loading="lazy"
                          className="nav-individual_visual"
                        />
                        <div className="nav-link_product-col-inside">
                          <a
                            href="https://help.multiversx.com/en/"
                            target="_blank"
                            className="nav-link_separate w-inline-block"
                          >
                            <div className="p_14">Support</div>
                          ...
                          <a
                            ...
                            className="nav-link_separate w-inline-block"
                          >
                            <div className="p_14">See official channels</div>
                            <div className="icon_10 w-embed">
                              <svg
                                width="100%"
                                height="100%"
                      ...
                      <div className="nav-link_product-col-menu">
                        <a
                          href="/individuals/get-started"
                          className="nav-llnk_drop-down w-inline-block"
                        >
                          <img
                          ...
                          <div className="f_vertical-left">
                            <div className="nav-llnk_drop-down-text-wrap">
                  ...
                  <div className="drop-open_icon individuals w-embed">
                    <svg
                      width="100%"
                      height="100%"
                      viewBox="0 0 42 15"
              ...
              >
                ...
                <div className="drop_open">
                      ...
                      <div className="nav-link_product-col">
                        <div className="nav-top-cta">
                          ...
                          <a
                            ...
                            target="_blank"
                            className="btn teal-small w-inline-block"
                          >
                            <div
                              color-mode="light"
                              className="btn_bg bg_dark-teal"
                            ></div>
                            <div className="p_14">xDay 2023 hackathon</div>
                            <div className="icon_14 w-embed">
                              <svg
                                width="100%"
                                height="100%"
                                viewBox="0 0 14 12"
                        ...
                        <div className="nav-link_product-col-inside">
                          ...
                          <a
                            ...
                            className="nav-link_separate w-inline-block"
                          >
                            <div className="p_14">Developer Discord</div>
                            <div className="icon_10 w-embed">
                              <svg
                                width="100%"
                                height="100%"
                  ...
                  <div className="drop-open_icon builders w-embed">
                    <svg
                      width="100%"
                      height="100%"
                      viewBox="0 0 42 15"
              ...
              <a href="/sovereign-chains" className="nav-llnk w-inline-block">
              ...
              >
                ...
                <div className="drop_open">
                  <div className="drop_holder">
                    <div clip="true" className="nav-link_product-wrap">
                      <div className="nav-link_product-col">
                        <div className="nav_partner-apply-wrap">
                          <div className="nav_partner-apply">
                            <div>
                              <div className="p_14">Partner Program</div>
                              <div className="p_14 text_neutral-400">
                            ...
                            >
                              <div
                                ...
                                className="btn_bg bg_dark-teal"
                              ></div>
                              <div className="p_14">Become a Partner</div>
                              <div className="icon_14 w-embed">
                                <svg
                                  width="100%"
                                  height="100%"
                  ...
                  <div className="drop-open_icon ecosystem w-embed">
                    <svg
                      width="100%"
                      height="100%"
                      viewBox="0 0 42 15"
              ...
              >
                ...
                <div className="drop_open">
                    ...
                    <div clip="true" className="nav-link_product-wrap">
                        ...
                        <div className="nav-top-cta">
                          ...
                          >
                            <div
                              ...
                              className="btn_bg bg_dark-teal"
                            ></div>
                            <div className="p_14">xDay 2023 Highlights</div>
                            <div className="icon_14 w-embed">
                              <svg
                                width="100%"
                                height="100%"
                          ...
                          <img
                            ...
                            className="nav-top-cta_img"
                          />
                          <div className="nav_top-cta-gradient"></div>
                        </div>
                        <img
                          src="../cdn.multiversx.com/webflow/nav-community-visual.webp"
                          loading="lazy"
                          className="nav_community-visual"
                        />
                        <img
                          src="../cdn.multiversx.com/webflow/nav-individual-grid.webp"
                          loading="lazy"
                          className="nav-individual_grid"
                        />
                        <div className="nav-social_wrap">
                          <div className="nav-social_top">
                            <div className="p_14 text_neutral-500">Connect</div>
                            <a
                              href="https://linktr.ee/multiversx"
                              target="_blank"
                              className="nav-link_separate w-inline-block"
                          ...
                          <div className="social_wrap is-nav">
                            <a
                              aria-label="Twitter / X Profile"
                              href="https://twitter.com/MultiversX"
                              target="_blank"
                              className="st-custom-button is--nav w-inline-block"
                            >
                      ...
                      <div className="nav-link_product-col-menu">
                        ...
                        >
                          ...
                          <div className="f_vertical-left">
                            <div className="nav-llnk_drop-down-text-wrap">
                              <div className="p_14">Ambassador Program</div>
                              <div
                                data-twothree-count=""
                                className="link-flavor"
                              >
                                <div className="powered-text_inner">
                                  <div>SOON</div>
                                </div>
                  ...
                  <div className="drop-open_icon community w-embed">
                    <svg
                      width="100%"
                      height="100%"
                      viewBox="0 0 42 15"
              ...
              >
                ...
                <div className="drop_open">
                  ...
                  <div className="drop-open_icon about w-embed">
                    <svg
                      width="100%"
                      height="100%"
                      viewBox="0 0 42 15"
      ...
      <Script
        async
        src="https://www.googletagmanager.com/gtag/js?id=G-96HM7BQNYF"
      />
      <Script id="google-analytics" strategy="afterInteractive">
       ...
       gtag("set", "developer_id.dZGVlNj", true);
          ...
          gtag('config', 'G-96HM7BQNYF');
        `}
      </Script>
      {/* External Clarity Script */}
      <Script
        src="/cdn.prod.website-files.com/6597cc7be68d63ec0c8ce338%252F652d31f3dc22d7b4ee708e44%252F65e8329da8133b63e80894bb%252Fclarity_script-5.0.5.js"
